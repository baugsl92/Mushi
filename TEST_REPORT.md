...
- deterministic model, geometry, weather-parser, alert, cooldown, observation, repository-link, Codespaces, Issue Form, and workflow tests
- Python syntax compilation for the GitHub-first Streamlit changes
- shell syntax checks for Codespaces startup and shutdown scripts
